...
// Chien: Aparentemente este js no tiene utilidad, por lo tanto queda comentado, se puede considerar eliminarlo.
...
//     $(document).on("click", ".subcategchocolates", function(ev){
//         ev.preventDefault();
